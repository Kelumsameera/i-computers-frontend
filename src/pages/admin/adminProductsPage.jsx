  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-slate-50 via-blue-50 to-indigo-50">
      <div className="w-full p-2 lg:p-2">
            ...
            <div className="flex flex-col lg:flex-row gap-4">
              ...
              <div className="relative">
                ...
                <select
                  value={filterStatus}
                  onChange={(e) => setFilterStatus(e.target.value)}
                  className="w-full lg:w-auto pl-12 pr-8 py-3 bg-slate-50 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 appearance-none cursor-pointer lg:min-w-[180px]"
                >
                  <option value="all">All Products</option>
                  <option value="available">In Stock</option>
                  <option value="unavailable">Out of Stock</option>
          ...
          {loaded && filteredProducts.length > 0 && (
            <div className="overflow-x-auto">
              <table className="w-full text-sm" >
                ...
                <thead className="bg-linear-to-r from-slate-800 to-slate-700 text-white">
                  <tr>
                    <th rowSpan="2" className="px-3 lg:px-4 py-4 text-left text-xs font-semibold uppercase tracking-wider">
                      Image
                    </th>
                    <th rowSpan="2" className="px-3 lg:px-4 py-4 text-left text-xs font-semibold uppercase tracking-wider">
                      Product ID
                    </th>
                    <th colSpan="4" className="px-2 lg:px-4 py-4 text-center text-xs font-semibold uppercase tracking-wider border-b border-slate-600">
                      Product Information
                    </th>
                    <th colSpan="2" className="px-3 lg:px-4 py-4 text-center text-xs font-semibold uppercase tracking-wider border-b border-slate-600">
                      Pricing
                    </th>
                    <th rowSpan="2" className="px-3 lg:px-4 py-4 text-center text-xs font-semibold uppercase tracking-wider">
                      Stock
                    </th>
                    <th rowSpan="2" className="px-3 lg:px-4 py-4 text-center text-xs font-semibold uppercase tracking-wider">
                      Status
                  ...
                  <tr className="bg-slate-700">
                    <th className="px-2 lg:px-3 py-2 text-left text-xs font-medium">Name</th>
                    <th className="px-2 lg:px-3 py-2 text-left text-xs font-medium">Category</th>
                    <th className="px-2 lg:px-3 py-2 text-left text-xs font-medium">Brand</th>
                    <th className="px-2 lg:px-3 py-2 text-left text-xs font-medium">Model</th>
                    <th className="px-2 lg:px-3 py-2 text-left text-xs font-medium">Price</th>
                    <th className="px-2 lg:px-3 py-2 text-left text-xs font-medium">MSRP</th>
                  </tr>
                </thead>
                ...
                <tbody className="divide-y divide-slate-100">
                  {filteredProducts.map((item) => (
                    <tr
                      ...
                      className="hover:bg-blue-50 transition-colors group"
                    >
                      <td className="px-3 lg:px-3 py-4">
                        <div className="relative">
                          <img
                            src={item.images?.[0]}
                            alt={item.name}
                      ...
                      <td className="px-3 lg:px-2 py-4 text-slate-600">{item.brand}</td>
                      <td className="px-3 lg:px-3 py-4 text-slate-600">{item.model}</td>

                      <td className="px-3 lg:px-3 py-4">
                        <span className="font-xs text-slate-800 text-base">
                      ...
                      <td className="px-3 lg:px-3 py-4 text-center">
                        <span className={`inline-flex items-center justify-center w-12 h-12 rounded-lg font-bold text-sm ${
                          item.stock > 50 
                            ? "bg-green-100 text-green-700" 
                            : item.stock > 0 
        ...
        <Link
          to="/admin/add-product"
          className="fixed right-4 lg:right-6 bottom-4 lg:bottom-6 w-14 lg:w-16 h-14 lg:h-16 flex justify-center items-center rounded-full bg-linear-to-br from-blue-600 to-indigo-600 text-white shadow-2xl hover:shadow-blue-500/50 hover:scale-110 transition-all duration-300 group z-50"
        >
          <BiPlus className="text-3xl lg:text-4xl group-hover:rotate-90 transition-transform duration-300" />
          <span className="absolute -top-12 right-0 bg-slate-800 text-white text-xs px-3 py-1.5 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap shadow-lg">
            Add New Product
          </span>
        </Link>
