...
//           <div className="absolute bottom-20 right-20 w-96 h-96 bg-yellow-500 rounded-full blur-3xl animate-pulse" />
//         </div>
...
//             {/* Badge */}
//             <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-orange-400/20 bg-orange-400/10 backdrop-blur-sm">
...
//               Upgrade your{" "}
//               <span className="bg-linear-to-r from-orange-400 via-yellow-400 to-amber-400 bg-clip-text text-transparent">
//                 tech game
//               </span>{" "}
...
//               <Link
//                 to="/products"
//                 className="rounded-full bg-linear-to-r from-orange-400 via-yellow-400 to-amber-400  px-8 py-3 text-sm font-semibold text-black shadow-lg shadow-orange-500/30 hover:bg-orange-400/20 hover:scale-105 transition"
//               >
//                 Shop Products
//               </Link>
...
//               <Link
//                 to="/about"
//                 className="rounded-full border border-gray-600 bg-white/5 px-8 py-3 text-sm font-semibold text-gray-100 backdrop-blur-sm hover:border-orange-400 hover:bg-white/10 hover:scale-105 transition"
//               >
//                 Learn About Us
//               </Link>
//             </div>
...
//                   className="w-full px-6 py-4 bg-gray-900/80 border border-gray-700 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:border-orange-400 backdrop-blur-md transition"
//                   aria-label="Search products"
//                 />
//                 <button
//                   type="submit"
//                   className="absolute right-2 top-1/2 transform -translate-y-1/2 px-6 py-2 bg-orange-400 text-black font-semibold rounded-lg hover:bg-orange-300 transition"
...
//                             isActive
//                               ? "border-orange-400 shadow-yellow-400/30 shadow-2xl"
//                               : "border-gray-700"
//                           }`}
//                         >
...
//                             <span className="absolute top-4 right-4 bg-linear-to-r from-orange-500 to-yellow-400 text-black px-3 py-1 text-xs font-bold rounded-full">
...
//                                   isActive
//                                     ? "bg-linear-to-r from-orange-500 to-yellow-400 text-black hover:scale-105"
...
//                           {isActive && (
//                             <div className="absolute inset-0 border-2 border-orange-400 rounded-2xl animate-pulse pointer-events-none" />
//                           )}
//                         </div>
//                       </div>
//                     );
...
//                 <button
//                   onClick={prevSlide}
//                   className="absolute left-0 top-1/2 -translate-y-1/2 z-40 bg-linear-to-r from-orange-500 to-yellow-500 text-white w-10 h-10 sm:w-12 sm:h-12 rounded-full shadow-lg shadow-orange-500/30 hover:scale-110 transition flex items-center justify-center"
...
//                 <button
//                   onClick={nextSlide}
//                   className="absolute right-0 top-1/2 -translate-y-1/2 z-40 bg-linear-to-r from-orange-500 to-yellow-500 text-white w-10 h-10 sm:w-12 sm:h-12 rounded-full shadow-lg shadow-orange-500/30 hover:scale-110 transition flex items-center justify-center"
...
//                         i === currentSlide
//                           ? "w-10 h-3 bg-linear-to-r from-orange-400 to-yellow-500 rounded-full"
...
//                 className="p-4 bg-gray-800 rounded-lg border border-gray-700 hover:border-orange-400 hover:bg-gray-700 cursor-pointer text-center transition focus:outline-none focus:ring-2 focus:ring-orange-400"
//                 aria-label={`Browse ${c.name}`}
//               >
//                 <div className="text-2xl mb-2" aria-hidden="true">{c.icon}</div>
//                 <p className="text-gray-300 font-medium group-hover:text-orange-400">{c.name}</p>
//               </Link>
//             ))}
//           </div>
//         </div>
...
//                   <div
//                     key={product.productID}
//                     className="bg-gray-900 border border-gray-800 rounded-xl overflow-hidden hover:border-orange-400 group transition cursor-pointer"
//                   >
//                     {/* Image */}
...
//                         <Link
//                           to={`/overview/${product.productID}`}
//                           className="px-4 py-2 bg-orange-400 text-black rounded font-semibold hover:bg-orange-300 transition"
//                         >
//                           View
//                         </Link>
//                       </div>
...
//             <Link
//               to="/products"
//               className="text-orange-400 hover:text-orange-300 font-medium flex items-center gap-2 focus:outline-none focus:underline"
//             >
//               View All
//               <svg
//                 className="w-5 h-5"
...
//                 <div
//                   key={product.productID}
//                   className="bg-gray-900 border border-gray-800 rounded-lg overflow-hidden hover:border-orange-400 transition group cursor-pointer"
//                 >
//                   {/* Product Image */}
...
//                   {/* Card Details */}
//                   <div className="p-5">
//                     <h3 className="text-lg font-semibold mb-2 text-white group-hover:text-orange-400 transition">
//                       {product.name}
//                     </h3>
...
//                       <Link
//                         to={`/overview/${product.productID}`}
//                         className="px-4 py-2 bg-orange-400 text-black font-semibold rounded hover:bg-orange-300 transition"
//                       >
//                         View
//                       </Link>
//                     </div>
